...
<section id="hire1" class="section padding-bottom" style="  overflow-y: hidden ! important;
                                                            overflow-x: hidden ! important;
                                                        background-image: url('http://api.file-dog.shatkonlabs.com/files/rahul/979');
                                                        background-size:     contain;                      /* <------ */
                                                        background-repeat: no-repeat;
                                                            background-position: top;">
    <header class="container text-center">
        <h3 class="fancy box">Recomended Services</h3>
